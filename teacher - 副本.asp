  ...
  <form action="?action=submitup" name="form1" method="post" onsubmit="return check()">
    ...
    <table width="892" border="1" cellpadding="0" cellspacing="0" id="teclist">
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team0">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>行政组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount0*0.2)%> 人)</span><input type="hidden" name="teamCount0" value="<%=teamCount0%>" /></td>
        </tr>
      <%
	  	i=1
		do while not Rs.Eof
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team1">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>语文组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount1*0.2)%> 人)</span><input type="hidden" name="teamCount1" value="<%=teamCount1%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team2">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>数学组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount2*0.2)%> 人)</span><input type="hidden" name="teamCount2" value="<%=teamCount2%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team3">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>英语组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount3*0.2)%> 人)</span><input type="hidden" name="teamCount3" value="<%=teamCount3%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team4">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>综合组 </strong> <span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount4*0.2)%> 人)</span><input type="hidden" name="teamCount4" value="<%=teamCount4%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team5">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>国际部 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount5*0.2)%> 人)</span><input type="hidden" name="teamCount5" value="<%=teamCount5%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team6">
        ...
        %>
      	<tr>
        <td colspan="9" align="left" valign="middle" class="pl10"><strong>后勤组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount6*0.2)%> 人)</span><input type="hidden" name="teamCount6" value="<%=teamCount6%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
