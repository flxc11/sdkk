...
(function(jQuery) {
	...
	this.each(function() {
		...
		jQuery.fn.setVariables = function() {
			dlWidth = jQuery(this).width();//1000
			dlHeight = jQuery(this).height();//442
			dtWidth = jQuery(this).find('dt').outerHeight();//!IE=26,IE=549
			if (jQuery.browser.msie && jQuery.browser.version !=10){ dtWidth = $(this).find('dt').outerWidth();}
			dtHeight = dlHeight - (jQuery(this).find('dt').outerWidth()-jQuery(this).find('dt').width());
            if(jQuery.browser.version == 9.0){
                dtHeight = dlHeight - (jQuery(this).find('dt').outerHeight() - jQuery(this).find('dt').width());
            }
		...
		if (jQuery.browser.safari){ var dtTop = (dlHeight-dtWidth)/2; var dtOffset = -dtTop;   
		/*Safari and Chrome*/  }
		...
		jQuery(this).find('dt').each(function(){
			...
			if(settings.slideNum == true){
				...
				if(jQuery.browser.msie){	
					...
					if(jQuery.browser.version == 8.0 || jQuery.browser.version == 9.0 || jQuery.browser.version == 10.0){
