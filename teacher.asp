...
<%
	...
	Sqlq = "select * from sorcetec where StuCode='"&CodeID&"'"
	...
	next
	Rs.Close:Set Rs=Nothing
	Response.Write("<script>alert('评分成功');window.location.href='tecchoose.asp';</script>")
	Response.End()
	end if	
%>
  ...
  <form action="?action=submitup" name="form1" method="post" onsubmit="return check()">
    ...
    <table width="892" border="1" cellpadding="0" cellspacing="0" id="teclist">
      <tr>
        ...
        <td colspan="4" valign="top" bgcolor="#FFFFFF"><p align="center">师德评价 </p></td>
        <td width="220" rowspan="2" valign="middle" bgcolor="#FFFFFF"><p align="center">备注 </p></td>
      </tr>
      <tr>
        <td width="87" valign="top" bgcolor="#FFFFFF"><p align="center">好<a href="javascript:checkall(100)">(全选)</a></p></td>
        <td width="87" valign="top" bgcolor="#FFFFFF"><p align="center">较好<a href="javascript:checkall(80)">(全选)</a></p></td>
        <td width="87" valign="top" bgcolor="#FFFFFF"><p align="center">一般<a href="javascript:checkall(60)">(全选)</a></p></td>
        <td width="90" align="center" valign="top" bgcolor="#FFFFFF"><p>差<a href="javascript:checkall(50)">(全选)</a></p></td>
      </tr>
      </table>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team0">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>行政组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount0*0.2)%> 人)</span><input type="hidden" name="teamCount0" value="<%=teamCount0%>" /></td>
        </tr>
      <%
	  	i=1
		do while not Rs.Eof
      ...
      <tr onmousemove="this.bgColor='#EEF2FB'" onmouseout="this.bgColor=''">
        ...
        <td width="90" align="center" valign="middle"><p><input type="radio" name="radio<%=i%>" id="radioa4<%=i%>" value="50" /></p></td>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team1">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>语文组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount1*0.2)%> 人)</span><input type="hidden" name="teamCount1" value="<%=teamCount1%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team2">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>数学组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount2*0.2)%> 人)</span><input type="hidden" name="teamCount2" value="<%=teamCount2%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team3">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>英语组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount3*0.2)%> 人)</span><input type="hidden" name="teamCount3" value="<%=teamCount3%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team4">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>综合组 </strong> <span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount4*0.2)%> 人)</span><input type="hidden" name="teamCount4" value="<%=teamCount4%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team5">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>国际部 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount5*0.2)%> 人)</span><input type="hidden" name="teamCount5" value="<%=teamCount5%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
      ...
      <table width="892" border="1" cellpadding="0" cellspacing="0" id="team6">
        ...
        %>
      	<tr>
        <td colspan="7" align="left" valign="middle" class="pl10"><strong>后勤组 </strong><span style="font:normal;font-size:16px;color:black">(必选“好” <%=Round(teamCount6*0.2)%> 人)</span><input type="hidden" name="teamCount6" value="<%=teamCount6%>" /></td>
        </tr>
      <%
		do while not Rs.Eof
	  %>
...
function check() {
	...
	$(".class table[id^='team']").each(function(i, v) {
		...
		if (choose_c < tcount || good_count2 != good_count1) {
			txt += tname + " 共 " + tcount + " 人 ,已选择 " + choose_c + " 人，应选择 '好' " + good_count1 + " 人，实选 " + good_count2 + "人," + moretxt + "\n\n";
			rlt = false;
		}
    });
	if (rlt == false) {
