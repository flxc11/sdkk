...
Sql="Select * From userreg1 Where code='"&UserName&"' And Password1='"&UserPass&"' or code='"&UserName&"' and Password2='"&UserPass&"'"
Rs.Open Sql,Conn,1,1
If Not (Rs.Eof And Rs.Bof) Then
Response.Cookies("CNVP_CMS2")("Code") = UserName

Response.Write("<script>top.window.location.href='tecchoose.asp';</script>")
Else
...
<div class="container">
  <div class="container_left">
        ...
        <table width="250" border="0" cellspacing="0" cellpadding="0" style="margin-top:80px; color:#fff" align="center">
            <tr>
              <td width="50" height="30" align="center">职工号：</td>
              <td width="200">
        ...
        <table width="250" border="0" cellspacing="0" cellpadding="0" style="margin-top:22px; color:#fff" align="center">
          <tr>
            <td width="50">&nbsp;</td>
            <td width="200" align="center">教职工登录</td>
          </tr>
        </table>
