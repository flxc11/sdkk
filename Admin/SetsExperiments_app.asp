...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Experiment_list.asp">成套实验申请</a>
</td>
...
<th width="31%" class="Right">成套实验名称<a href="#" onclick="top.CreateNewTab('Experiment_add.asp','Experiment_add','添加实验记录')">[+]</a></th>
...
<td class="Right"><a href="SetsExperimentsq.asp?ID=<%=Rs("ID")%>&Page=<%=Page%>"><%=Rs("ExperiTitle")%></a></td>
<td class="Right">
<%
...
<td class="Right">&nbsp;</td>
<td><a href="SetsExperimentsq.asp?ID=<%=Rs("ID")%>&Page=<%=Page%>">申请</a></td>
</tr>
<%
i=i+1
Rs.MoveNext
