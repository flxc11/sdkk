...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Pro_ContentListIn.asp">仪器列表</a>
<%
If ShopName<>"" Then
...
<td width="75%" valign="top">1.以下为所有仪器的信息列表；<br />
  2.单击&quot;[+]&quot;添加新仪器；<br />
  3.单击&quot;仪器名称&quot;对该仪器的信息编辑，也可单击&quot;管理操作中的编辑&quot;
  ；<br>
...
<th width="31%" class="Right">仪器名称<a href="#" onclick="top.CreateNewTab('Pro_ContentAdd.asp?ClassID=<%=ClassID%>','Pro_ContentAdd','添加商品')">[+]</a></th>
<th width="27%" class="Right">仪器类别</th>
<th width="13%" class="Right">仪器库存</th>
<th width="12%" class="Right">仪器总数</th>
<th width="9%">管理操作</th>
</tr>
...
%>
<tr>
<th colspan="3" style="font-weight:normal">操作：&nbsp;<a href="javascript:ChangeParent();" style="font-weight:normal">转移</a>&nbsp;┊&nbsp;<a href="Pro_ContentListInFind.asp?ClassID=<%=ClassID%>&ShowType=<%=ShowType%>" style="font-weight:normal">查找</a>&nbsp;┊&nbsp;<a href="Pro_SumAll.asp" style="font-weight:normal">汇总</a></th>
