...
<tr>
<th colspan="4">中层及以上评分结果：</th>
</tr>
<tr>
  <td  align="center" width="20%" class="Right">职工号</td>
  <td width="20%" align="center" valign="middle" class="Right">姓名</td>
  <td width="20%" align="center" class="Right">教师评分</td>
  <td width="20%" align="center" class="Right">备注</td>
  </tr>
  <%
  	TecCode=Request("TecCode")
  	Set Rs=Server.CreateObject("Adodb.RecordSet")
	Sql = "select * from sorcetec where TecCode='"&TecCode&"' and ISXZ='是'"
...
<tr onmouseover="this.bgColor='#EEF2FB'" onmouseout="this.bgColor=''">
  ...
  <td align="center" class="Right"><%=Rs("TecSorce")%></td>
