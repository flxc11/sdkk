...
If Action="Save" Then
	...
	Sql="Select * From RoomClass Where ID="&ID&""
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u7c7b\u522b\u540d\u79f0\u4fee\u6539\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='Room_Class.asp?ID="&ParentID&"';</script>")
	Response.End()
End If
%>
...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Room_Class.asp">信息分类维护</a> >> 编辑分类</td>
...
<td colspan="2"><input type="submit" value="保 存" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='Room_Class.asp?ID=<%=ParentID%>'"></td>
</tr>
</table>
</form>
</td>
