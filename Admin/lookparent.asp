...
<tr>
<th colspan="4">家长评分结果：</th>
</tr>
<tr>
  <td  align="center" width="20%" class="Right">学号</td>
  <td width="20%" align="center" valign="middle" class="Right">姓名</td>
  <td width="20%" align="center" class="Right">家长评分</td>
  <td align="center">备注</td>
  </tr>
  <%
  	TecCode=Request("TecCode")
  	Set Rs=Server.CreateObject("Adodb.RecordSet")
	Sql = "select * from sorceparent where TecCode='"&TecCode&"'"
	Rs.Open Sql,Conn,1,1
	do while not Rs.Eof
  %>
<tr onmouseover="this.bgColor='#EEF2FB'" onmouseout="this.bgColor=''">
  <td class="Right" align="center"><%=Rs("StuCode")%></td>
  <td align="center" class="Right"><%=GetStuName("SetsExperiments",Rs("StuCode"))%></td>
  <td align="center" class="Right"><%=left(Rs("TecSorce")/6,5)%></a></td>
