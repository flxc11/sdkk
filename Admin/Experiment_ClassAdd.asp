...
If Action="Save" Then
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u4fe1\u606f\u5206\u7c7b\u4fe1\u606f\u6dfb\u52a0\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='Experiment_Class.asp?ID="&ID&"';</script>")
	Response.End()
End If
%>
...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Experiment_Class.asp">实验分类维护</a> >> 添加实验分类</td>
...
<td colspan="2"><input type="submit" value="保 存" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='Experiment_Class.asp'"></td>
</tr>
</table>
</form>
</td>
